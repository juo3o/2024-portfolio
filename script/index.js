$(document).ready(function(){
    //인트로 버튼 애니메이션
        $('.ib1').animate({left:'460px'}, 1200, function(){
            $(this).css({'background-color': '#6DED6D', 'color': '#000', 'font-weight' : 'bold' });
            $('.ib2').animate({left:'540px'}, 1200, function(){
                $(this).css({'background-color': '#6DED6D', 'color': '#000', 'font-weight' : 'bold' });
                $('.ib3').animate({left:'360px'}, 1200, function(){
                    $(this).css({'background-color': '#6DED6D', 'color': '#000', 'font-weight' : 'bold' });
                });
            });
        });
    ...
    //스크롤시 메뉴 색상 변경...
        $(window).scroll(function () { 
            ...
            if (scrollValue==0) {
                ...
                $('.menu_tag').css('opacity','1');
            } else {
                $('header').css('opacity','1');
                $('.menu_tag').css('opacity','0');
            }
